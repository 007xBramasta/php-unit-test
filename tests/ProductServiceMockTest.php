...
class ProductServiceMockTest extends TestCase
{
    ...
    public function testStub() //Test Stub Product
    {
        $product = new Product();
        $product->setId("1");
    ...
    public function testStubMap() //Test Konfigurasi Stub Product With Map  
    {
    ...
    public function testStubCallBack() //Test Stub CallBack Configuration
    {
        $this->repository->method("findById")
    ...
    public function testRegisterSuccess() //Test Stub Success Register
    {
    ...
    public function testRegisterException() //Test Stub Register Exception
    {
